import { weekdays, subjects, getSubject, convertHoursToMinutes } from "./utils/format.js"
import Database from './database/db.js'
import createProf from './database/createProf.js'
...
async function pageStudy(req, res) {
    ...
    try {
        ...
        return res.render('study.html', { profs, subjects, filters, weekdays })
    } catch (error) {
        console.log(error)
    }
}
